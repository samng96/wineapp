            ...
            return `
                <div class="wine-item" data-instance-id="${instance.id}">
                    ...
                    <div class="wine-item-details">
                        ...
                        ${instance.drinkByDate ? `<div class="wine-item-drink-by"><span class="wine-item-storage-label">Drink by: </span><span>${this.formatStoredDate(instance.drinkByDate)}</span></div>` : ''}
